# Generated by Powerlevel10k configuration wizard on 2024-10-23 at 22:14 WEST.
...
() {
  ...
  function prompt_myuser() {
     p10k segment -f 3 -i '󱑷' -t '%n'
  }

  function instant_prompt_myuser() {
     prompt_myuser
  }
